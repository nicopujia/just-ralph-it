...
export function renderExplorerAgentDescriptor(model: Required<AgentConfig>): string {
  return [
    ...
    "When the delegated task includes JRI web capability instructions, follow only the JRI-owned capability steps provided for required current external facts.",
