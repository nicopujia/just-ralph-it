...
STATUS_ENDED = "The last run ended with `{ending}`. The next `jri chat` window puts that run in the conversation."
...
STATUS_STARTING = "A run is going, in process {pid}. It has written nothing down yet."
...
TITLE = "Just Ralph It"
# The header shows the app name first and the project name after it. This mark divides the two names.
TITLE_SEPARATOR = " / "
