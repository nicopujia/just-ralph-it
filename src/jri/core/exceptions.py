...
# JRI sends the whole notebook to one model call, and this notebook does not fit one. Every run of this notebook
# ends the same way until JRI carries a notebook of this size, so this is not a fault the user can clear.
class NotebookTooLargeError(Error): ...
