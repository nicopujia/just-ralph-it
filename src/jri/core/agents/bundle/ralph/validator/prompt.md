...
- For user-facing public MVP work, provide obtainable interaction QA evidence from the matching public surface, not only automated checks.
...
- For user-facing public MVP work, omit obtainable hands-on QA evidence for the relevant surface: browser/Playwright for web when available, or equivalent CLI, TUI, API, SDK, service, or hosted-public interaction evidence.
