...
export default tool({
  name: "promote-tasks",
  description:
    "Validate or promote draft tasks to todo using the core promotion logic. This is the canonical way to promote draft tasks; defaults to all draft tasks when `slugs` is omitted.",
  args: {
    slugs: tool.schema
