...
REQUIRED_AGENT_RESOURCES = {
    ...
    "src/jri/core/agents/bundle/(shared)/registry.ts",
    "src/jri/core/agents/bundle/(shared)/subagents.ts",
    "src/jri/core/agents/bundle/(shared)/commits.ts",
    "src/jri/core/agents/bundle/(shared)/assets.ts",
    ...
    "src/jri/core/agents/bundle/(shared)/runner.ts",
