...
import { renderWebCapabilityInstructions, webCapabilityDescriptor } from "../src/core/capabilities";
...
describe("capability descriptors", () => {
  ...
  test("planner and builder prompts include concrete web capability instructions", async () => {
